...
#define NUTBLAST_FIELD_VALUE_MAX (1023)
...
/// Establishing a P2P connection to one of the players using STUN has failed; disconnecting self so as not to hinder
/// others' gameplay.
#define NUTBLAST_ERROR_STUN_FAILED "humane_disconnection"
...
///
/// Under the hood, just gives you the latest "error"-level log message.
...
/// Purges lobby & player metadata if it concerns you that metadata is kept between sessions.
